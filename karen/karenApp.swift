...
struct karenApp: App {
    ...
    @StateObject private var settingsManager = SettingsManager() // Create the manager
    ...
    var body: some Scene {
        WindowGroup {
            ContentView()
                ...
                .environmentObject(settingsManager) // Inject into the environment
        }
        .commands {
        ...
        // Add the standard Settings scene
        Settings {
